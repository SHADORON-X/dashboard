-- ================================================================
-- 🔥 MIGRATION 30: OPTIMISATION SYNC PULL (PAGINATION IMPLICITE)
-- ================================================================
-- Date: 26 Décembre 2025
-- Objectif: Ajouter une limite de 1000 enregistrements par appel RPC
-- pour éviter les crashs mémoire (OOM) sur les gros datasets.
-- Le client (WatermelonDB) gérera la pagination naturellement
-- en mettant à jour son last_sync_time et en rappelant la fonction.
-- ================================================================
...
DECLARE
    v_shop_id UUID;
    v_limit INTEGER := 1000; -- 🛡️ Sécurité anti-OOM
BEGIN
    ...
    -- Router vers la bonne table avec LIMIT
